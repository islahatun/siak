                ...
                <tr>
                    <td colspan="3">
                        <div class="text-center font-weight-bold">
                            <h1><u> SURAT KETERANGAN DOMISILI</u></h1>
                        </div>

                        <div class="text-center">
                            <h4>Nomor : <?= $surat['id_acc']; ?>/KS-558/Ds.2007/III/<?= date('Y') ?></h4>
                        </div>
                        <p></p>
                        <div>
                        ...
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4>: <?= $surat['tempat_lahir'] . ', ' . $surat['tanggal_lahir'] ?></h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-1">
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4>: <?= $surat['alamat'] . ', ' . $surat['rt/rw'] . ', ' . $surat['desa'] . ', ' . $surat['kecamatan'] . ', ' . $surat['kabupaten'] ?></h4>
                                </div>
                            </div>
                            <p></p>
                            <p class="text-justify">
                            <h4>Nama tersebut di atas adalah benar berdasarkan hasil pengamatan dan data yang ada pada register penduduk yang bersangkutan Benar tercatat berdomisili diwilayah Desa Banjar Kec. Banjar Kab .Pandeglang sampai dengan surat ini diterbitkan.
