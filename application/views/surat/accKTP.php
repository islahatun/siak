                ...
                <tr>
                    <td colspan="3">
                        <div class="text-center font-weight-bold">
                            <h1><u> SURAT KETERANGAN</u></h1>
                        </div>

                        <div class="text-center">
                            <h4>Nomor : <?= $surat['id_acc']; ?>/KS-246/Ds.2007/III/<?= date('Y') ?></h4>
                        </div>
                        <p></p>
                        <div>
                        ...
                        <div>
                            ...
                            <p></p>
                            <p class="text-justify">
                            <h4>Nama tersebut di atas adalah benar penduduk Desa Banjar Kecamatan Banjar Kabupaten Pandeglang, yang bersangkutan akan melaksanakan perekaman KTP el.
